...
$(document).ready(function () {
    ...
    $("#delete_row").click(function () {
        ...
        $("#process").val(lst);
        $("#data").children(".cen").eq(lst * 4 + 3).remove();
        $("#data").children(".cen").eq(lst * 4 + 2).remove();
        $("#data").children(".cen").eq(lst * 4 + 1).remove();
        $("#data").children(".cen").eq(lst * 4).remove();
